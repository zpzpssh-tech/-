...
lines = [
 ...
 ["회수 대상 멘트", "안녕하세요, 올투게더나우 ○○○ 대표입니다. 그동안 함석민 님을 통해 진행하셨던 중국 생산 건(예: 클립펜·온습도계, 캐릭터 굿즈)은 실제로는 저희 중국 파트너 리자위 공장에서 만들어졌습니다. 현재 함석민 님과는 거래가 정리되어, 앞으로는 저희가 한국 창구를 맡아 같은 공장·같은 품질로 직접 진행해 드립니다. 중간 단계가 하나 빠지는 만큼 단가와 소통 속도 모두 유리합니다. 진행 중이거나 예정된 건 있으시면 바로 견적 드리겠습니다."],
